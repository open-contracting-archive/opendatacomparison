...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Dpotw'
        db.create_table(u'homepage_dpotw', (
        ...
        db.send_create_signal(u'homepage', ['Dpotw'])

        # Adding model 'Gotw'
        db.create_table(u'homepage_gotw', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal(u'homepage', ['Gotw'])

        # Adding model 'PSA'
        db.create_table(u'homepage_psa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('body_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'homepage', ['PSA'])


    def backwards(self, orm):
        # Deleting model 'Dpotw'
        db.delete_table(u'homepage_dpotw')

        # Deleting model 'Gotw'
        db.delete_table(u'homepage_gotw')

        # Deleting model 'PSA'
        db.delete_table(u'homepage_psa')
