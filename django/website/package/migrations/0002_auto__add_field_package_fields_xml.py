...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.fields_xml'
        db.add_column(u'package_package', 'fields_xml',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.fields_xml'
        db.delete_column(u'package_package', 'fields_xml')
    ...
    models = {
        ...
        u'package.package': {
            ...
            'fields_xml': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
