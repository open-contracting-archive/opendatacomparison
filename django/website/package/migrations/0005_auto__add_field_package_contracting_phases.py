...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.contracting_phases'
        db.add_column(u'package_package', 'contracting_phases',
                      self.gf('multiselectfield.db.fields.MultiSelectField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.contracting_phases'
        db.delete_column(u'package_package', 'contracting_phases')
    ...
    models = {
        ...
        u'package.package': {
            ...
            'contracting_phases': ('multiselectfield.db.fields.MultiSelectField', [], {'max_length': '100', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'languages': ('multiselectfield.db.fields.MultiSelectField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'package.translatedpackage': {
            'Meta': {'object_name': 'TranslatedPackage'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en_US'", 'max_length': '10'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'to': u"orm['package.Package']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': "'100'"})
        },
        u'package.version': {
