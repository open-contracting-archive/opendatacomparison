...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.documentation'
        db.add_column(u'package_package', 'documentation',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.documentation'
        db.delete_column(u'package_package', 'documentation')
