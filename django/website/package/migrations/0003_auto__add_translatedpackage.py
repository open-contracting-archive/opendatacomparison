...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TranslatedPackage'
        db.create_table(u'package_translatedpackage', (
        ...
        db.send_create_signal(u'package', ['TranslatedPackage'])


    def backwards(self, orm):
        # Deleting model 'TranslatedPackage'
        db.delete_table(u'package_translatedpackage')
