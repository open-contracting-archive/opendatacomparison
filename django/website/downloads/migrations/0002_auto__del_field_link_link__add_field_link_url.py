...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'downloads_link', 'link')

        # Adding field 'Link.url'
        db.add_column(u'downloads_link', 'url',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Link.link'
        raise RuntimeError("Cannot reverse this migration. 'Link.link' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Link.link'
        db.add_column(u'downloads_link', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200),
                      keep_default=False)

        # Deleting field 'Link.url'
        db.delete_column(u'downloads_link', 'url')
