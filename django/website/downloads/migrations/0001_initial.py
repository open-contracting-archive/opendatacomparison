...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Link'
        db.create_table(u'downloads_link', (
        ...
        db.send_create_signal(u'downloads', ['Link'])

        # Adding model 'Click'
        db.create_table(u'downloads_click', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['downloads.Link'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'downloads', ['Click'])


    def backwards(self, orm):
        # Deleting model 'Link'
        db.delete_table(u'downloads_link')

        # Deleting model 'Click'
        db.delete_table(u'downloads_click')
