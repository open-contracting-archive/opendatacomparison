...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Click.session_key'
        db.add_column(u'downloads_click', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='session', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Click.session_key'
        db.delete_column(u'downloads_click', 'session_key')
