...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Field'
        db.create_table(u'datamap_field', (
            ...
            ('fieldname', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('datatype', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'datamap', ['Field'])

        # Adding model 'TranslatedField'
        db.create_table(u'datamap_translatedfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamap.Field'])),
            ('language', self.gf('django.db.models.fields.CharField')(default='en_US', max_length=10)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('allowable_values', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'datamap', ['TranslatedField'])


    def backwards(self, orm):
        # Deleting model 'Field'
        db.delete_table(u'datamap_field')

        # Deleting model 'TranslatedField'
        db.delete_table(u'datamap_translatedfield')
