...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.concept'
        db.alter_column(u'datamap_field', 'concept_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datamap.Concept']))

    def backwards(self, orm):

        # Changing field 'Field.concept'
        db.alter_column(u'datamap_field', 'concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamap.Concept'], null=True))
    ...
    models = {
        ...
        u'datamap.field': {
            ...
            'concept': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datamap.Concept']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
