...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Concept', fields ['parent', 'name']
        db.delete_unique(u'datamap_concept', ['parent_id', 'name'])

        # Deleting field 'Concept.parent'
        db.delete_column(u'datamap_concept', 'parent_id')

        # Adding field 'Concept.phase'
        db.add_column(u'datamap_concept', 'phase',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concept.entity'
        db.add_column(u'datamap_concept', 'entity',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Concept.description'
        db.alter_column(u'datamap_concept', 'description', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding unique constraint on 'Concept', fields ['phase', 'entity']
        db.create_unique(u'datamap_concept', ['phase', 'entity'])

        # Adding field 'Field.englishname'
        db.add_column(u'datamap_field', 'englishname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Field.standardname'
        db.add_column(u'datamap_field', 'standardname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Field.datatype_notes'
        db.add_column(u'datamap_field', 'datatype_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Concept', fields ['phase', 'entity']
        db.delete_unique(u'datamap_concept', ['phase', 'entity'])

        # Adding field 'Concept.parent'
        db.add_column(u'datamap_concept', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamap.Concept'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Concept.phase'
        db.delete_column(u'datamap_concept', 'phase')

        # Deleting field 'Concept.entity'
        db.delete_column(u'datamap_concept', 'entity')


        # Changing field 'Concept.description'
        db.alter_column(u'datamap_concept', 'description', self.gf('django.db.models.fields.TextField')(default=''))
        # Adding unique constraint on 'Concept', fields ['parent', 'name']
        db.create_unique(u'datamap_concept', ['parent_id', 'name'])

        # Deleting field 'Field.englishname'
        db.delete_column(u'datamap_field', 'englishname')

        # Deleting field 'Field.formattedname'
        db.delete_column(u'datamap_field', 'formattedname')

        # Deleting field 'Field.standardname'
        db.delete_column(u'datamap_field', 'standardname')

        # Deleting field 'Field.datatype_notes'
        db.delete_column(u'datamap_field', 'datatype_notes')
    ...
    models = {
        ...
        u'datamap.field': {
            ...
            'englishname': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
