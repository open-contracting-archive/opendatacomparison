...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Concept', fields ['name']
        db.delete_unique(u'datamap_concept', ['name'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Concept', fields ['name']
        db.create_unique(u'datamap_concept', ['name'])
    ...
    models = {
        ...
        u'datamap.concept': {
            'Meta': {'unique_together': "(('parent', 'name'),)", 'object_name': 'Concept'},
